...
func (s *SnapshotStorage) EphemeralUpload(ctx context.Context, filename, snapshotHeaderOutput string, snapshotsPath string) {
	...
	if err := os.Chdir(snapshotsPath); err != nil {
